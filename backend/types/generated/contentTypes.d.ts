...
export interface ApiBestandBestand extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    afdeling: Schema.Attribute.Enumeration<
      ['Alle', 'HR', 'IT', 'Marketing', 'Verkoop', 'Management']
    >;
    auteur: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Beheerder'>;
    bekijkbaar: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    beschrijving: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 500;
      }>;
    bestand: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Schema.Attribute.Required;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    downloadbaar: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::bestand.bestand'
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    versie: Schema.Attribute.String & Schema.Attribute.DefaultTo<'1.0'>;
  };
}
...
export interface ApiNieuwsItemNieuwsItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    afbeelding: Schema.Attribute.Media<'images' | 'files'>;
    Auteur: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Pien - Elmar Services'>;
    Categorie: Schema.Attribute.Enumeration<
      ['Algemeen', 'HR', 'IT', 'Marketing ', 'Verkoop']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    inhoud: Schema.Attribute.Blocks & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::nieuws-item.nieuws-item'
    > &
      Schema.Attribute.Private;
    publicatieDatum: Schema.Attribute.Date;
    publishedAt: Schema.Attribute.DateTime;
    ...
    Uitgelicht: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
